...
describe EquipmentController do
  ...
  let(:valid_attributes) { { "equipment" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved equipment as @equipment" do
        ...
        post :create, {:equipment => { "equipment" => "invalid value" }}, valid_session
        assigns(:equipment).should be_a_new(Equipment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested equipment" do
        ...
        Equipment.any_instance.should_receive(:update).with({ "equipment" => "MyString" })
        put :update, {:id => equipment.to_param, :equipment => { "equipment" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the equipment as @equipment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Equipment.any_instance.stub(:save).and_return(false)
        put :update, {:id => equipment.to_param, :equipment => { "equipment" => "invalid value" }}, valid_session
        assigns(:equipment).should eq(equipment)
      end
