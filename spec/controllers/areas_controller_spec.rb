  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved area as @area" do
        ...
        post :create, {:area => { "area" => "invalid value" }}, valid_session
        assigns(:area).should be_a_new(Area)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested area" do
        ...
        Area.any_instance.should_receive(:update).with({ "area" => "MyString" })
        put :update, {:id => area.to_param, :area => { "area" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the area as @area" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Area.any_instance.stub(:save).and_return(false)
        put :update, {:id => area.to_param, :area => { "area" => "invalid value" }}, valid_session
        assigns(:area).should eq(area)
      end
