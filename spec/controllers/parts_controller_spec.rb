...
describe PartsController do
  ...
  let(:valid_attributes) { { "part" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved part as @part" do
        ...
        post :create, {:part => { "part" => "invalid value" }}, valid_session
        assigns(:part).should be_a_new(Part)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested part" do
        ...
        Part.any_instance.should_receive(:update).with({ "part" => "MyString" })
        put :update, {:id => part.to_param, :part => { "part" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the part as @part" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Part.any_instance.stub(:save).and_return(false)
        put :update, {:id => part.to_param, :part => { "part" => "invalid value" }}, valid_session
        assigns(:part).should eq(part)
      end
